...
<html  lang="en">
    ...
    <ul class="ml">
            ...
            <li><a href="CatCare.php" class="active">Cat Care</a></li>
            <li><a href="Give.php">Have a pet to give away?</a></li>
            <li><a href="Contact.php">Contact Us</a></li>
        </ul>
        <div class="content">
            <h2>Cat Care Instructions and Tips</h2>
            <p>If you're considering bringing home a new cat, please make adoption your first option. We encourage you to browse our <a href="BrowsePets.html" >directory of adoptable cats</a> in your area.</p>
            <p>
                <h3>Feeding</h3>
                <ul id="dogFeed">
            ...
            <p>We recommend purchasing high-quality, brand-name kitten or cat food. Your veterinarian will be able to assess your new cat or kitten and determine the best diet. Factors such as age, activity level and health make a difference in what and how much a cat should eat.</p>
            <p>
                <h3>Grooming</h3>
            ...
            <br/>
            <div class="copywrite">
                <a href="https://www.aspca.org/pet-care/cat-care/general-cat-care" target="_blank" rel="noreferrer noopener">Link</a> <br/>All text has been taken from the link above
            </div>
        </div>
    </body>
